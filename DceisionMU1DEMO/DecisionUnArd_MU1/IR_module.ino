...
//ping_test() yerine
void send_ping_message(Position MU1_NextPosition, Position targetPosition, int ID, uint8_t MU1_state){  
...
void send_ack_message(Position MU1_NextPosition, Position targetPosition, int ID, uint8_t MU1_state) {
...
void listener(Position& MU1_NextPosition, Position& MU2_NextPosition, Position& MU3_NextPosition, Position& targetPosition,uint8_t& MU1_state,uint8_t& MU2_state, uint8_t& MU3_state, int& buLink, uint8_t loop_iteration_wo_ping_message){
  ...
  if (listening_result == 1){ // i.e., the message received is succesful
    ...
    // Serial.println("x: " + String(received_x) + " y: " + String(received_y) + " intention: " + String(intention) + " received_ID: " + String(ID) + " target x: " + String(target_x)+ " target y: " + String(target_y)+ "\n");
