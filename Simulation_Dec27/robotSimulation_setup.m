function robotSimulation_setup(initial_position1, initial_position_2, initial_position_3, bu,targetLocation, obstacleLocations)
    % Create a 10x10 grid
    ...
    mu1Row = initial_position1(1);
    mu1Col = initial_position1(2);

    mu2Row = initial_position_2(1);
    mu2Col = initial_position_2(2);

    mu3Row = initial_position_3(1);
    mu3Col = initial_position_3(2);
    ...
    plotVector_2 = scatter(moves_made_2(:, 1), moves_made_2(:, 2), 'filled', 'Marker', 'x', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm');
