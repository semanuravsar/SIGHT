function [mu1_all,mu2_all,mu3_all,bu,targetPosition,i,obstaclePositions] = case1_updated(mu1,mu2,mu3,bu,targetPosition,obstaclePositions)
%%%%%%%%%%%%%%%%%%%%%%%%%%%% SEARCH ALGORITM %%%%%%%%%%%%%%%%%%%%%%%
