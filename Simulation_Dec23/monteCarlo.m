% MONTE CARLO for a SPECIFIC CASE
function [avgTargetFound] = monteCarlo(mu1, mu2, mu3, bu, targetPosition, obstaclePositions, monteCarloIteration)
...
for i=1:numberofiterations
    ...
    % if a collusion might occur, stay where you are
    ...
    if([currentPosition2(1), currentPosition2(2)] == [targetRow,targetCol])
        ...
        break
         ...
         if([nextPosition2(1), nextPosition2(2)] == [targetRow,targetCol])
             mu1_info(nextPosition2(1), nextPosition2(2))=6;
    ...
    if([currentPosition3(1), currentPosition3(2)] == [targetRow,targetCol])
        ...
        break
         ...
         if([nextPosition3(1),  nextPosition3(2)] == [targetRow,targetCol])
             mu1_info(nextPosition3(1), nextPosition3(2))=6;
...
avgTargetFound = sumTargetFound/monteCarloIteration;
