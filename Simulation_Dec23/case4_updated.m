function [mu1_all,mu2_all,mu3_all,bu,targetPosition,i,obstaclePositions] = case4(obstaclePositions)
%%%%%%%%%%%%%%%%%%%%%%%%%%%% SEARCH ALGORITM %%%%%%%%%%%%%%%%%%%%%%%
...
%     mu1_info(currentPosition1(1), currentPosition1(2))=6;knowled
%     targetisFound1 = 1;
%     break
%     end
