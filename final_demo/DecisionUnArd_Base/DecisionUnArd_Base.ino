...
void loop(){
  ...
  // Serial.println(targetPosition.x);
  ...
  if(targetPosition.x < 10 && targetPosition.y < 10 && targetPosition.x > 0 && targetPosition.y > 0){
    final_communication(buPosition, MU2_NextPosition, MU3_NextPosition, targetPosition, ID, MU1_state, MU2_state, MU3_state, buLink, active_s);
    // Serial.println("BUARYA G");
  }
  else{
    final_communication_before_target(buPosition, MU2_NextPosition, MU3_NextPosition, targetPosition, ID, MU1_state, MU2_state, MU3_state, buLink, active_s);
  }
