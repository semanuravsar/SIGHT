...
//ping_test() yerine
void send_ping_message(Position MU1_NextPosition, Position targetPosition, int ID, int MU1_state) {
  
  uint8_t nextPosition_x = MU1_NextPosition.x;
  uint8_t nextPosition_y = MU1_NextPosition.y;
...
void send_ack_message(Position MU1_NextPosition, Position targetPosition, int ID, int MU1_state) {
...
void final_communication(Position MU1_NextPosition, Position MU2_NextPosition, Position MU3_NextPosition, Position targetPosition, int ID, int MU1_state,int MU2_state,int MU3_state, int buLink, uint8_t active_s){
...
void listener(Position MU1_NextPosition, Position MU2_NextPosition, Position MU3_NextPosition, Position targetPosition,int MU1_state,int MU2_state, int MU3_state,int buLink, uint8_t loop_iteration_wo_ping_message){
  ...
  if (listening_result == 1){ // i.e., the message received is succesful
    ...
    if(received_ID == 2){
      ...
      if(target_x < 10 && targetPosition.x > 10){
