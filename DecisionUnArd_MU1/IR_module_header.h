...
void listener(Position MU1_NextPosition, Position MU2_NextPosition, Position MU3_NextPosition, Position targetPosition,int MU1_state,int MU2_state, int MU3_state, int buLink);
